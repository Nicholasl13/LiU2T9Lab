public class LuckyNumbers
{
    ...
    {
        return "My lucky numbers are: " + randomIntegerBetween(1,65) + "," +randomIntegerBetween(1,65) + "," +randomIntegerBetween(1,65) + "," +randomIntegerBetween(1,65) + "," +randomIntegerBetween(1,65) + "\nThe super number is: " + randomIntegerBetween(1,30);
    }
}
